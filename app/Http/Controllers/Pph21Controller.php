...
class Pph21Controller extends Controller
{
    ...
    public function pph21sub()
    {
        ...
        $pph21 = Pph21::join('karyawans', 'karyawans.id_pph21', '=', 'pph21s.id_pph21')
            ->get();
        //dd($pph21);
        return view('pph21.pph21sub', compact(['pph21', 'karyawan']));
    }
    ...
    public function update(Request $request, Pph21 $pph21, $id_pph21)
    {
        ...
        if ($request->karyawan == 'Karyawan') {
            ...
            $karyawan->nikKaryawan = null;
            $karyawan->npwpKaryawan = null;
        } else {
            $karyawan->karyawan = $request->karyawan;
            $karyawan->nikKaryawan = $request->nikKaryawan;
            $karyawan->npwpKaryawan = $request->npwpKaryawan;
        }
