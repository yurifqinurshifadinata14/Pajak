...
<main x-data="karyawan">
    <div class="container-fluid px-4">
        <h5 class="mt-4 d-inline d-md-none"> Data Karyawan </h5>
        <h1 class="mt-4 d-none d-md-block"> Data Karyawan </h1>
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <!-- Button Tambah -->
                    <button type="button" class="btn btn-sm btn-primary me-1 float-end" title="Tambah Data Karyawan"
                    ...
                    <button type="button" class="btn btn-sm btn-success me-1" title="Import Excel" data-bs-toggle="modal"
