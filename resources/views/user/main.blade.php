    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark bg-navy" id="accordionSidebar">
            ...
            <div class="sidebar-menu">
                ...
                <!-- Nav Item - Pph -->
                <li
                    class="nav-item {{ Request::is('user/pph') ? 'active' : '' }} d-flex align-items-center justify-content-center">
                    <a class="nav-link" href="{{ route('user.pph') }}" aria-expanded="true">
                        <i class="fas fa-fw fa-briefcase"></i>
                        <span>PPH</span>
                    </a>
                </li>
                ...
                <li
                    class="nav-item {{ Request::is('user/pphunifikasisub*') ? 'active' : '' }} d-flex align-items-center justify-content-center">
                    <a class="nav-link" href="{{ route('user.pphunifikasisub') }}" aria-expanded="true">
                        <i class="fas fa-fw fa-briefcase"></i>
