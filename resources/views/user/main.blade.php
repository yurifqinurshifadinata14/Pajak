    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark bg-navy" id="accordionSidebar">
            ...
            <div class="sidebar-menu">
                ...
                <li
                    class="nav-item {{ Request::is('pphunifikasisub*') ? 'active' : '' }} d-flex align-items-center justify-content-center">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile" src="{{ asset('KKP.png') }}" style="width: 80px; height:auto;">
                            </a>
