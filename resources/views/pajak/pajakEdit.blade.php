                ...
                <div class="card-body">
                    <form action="{{ route('pajakUpdate', $pajak->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_hp" name="no_hp" value="{{ $pajak->no_hp }}" placeholder="No Hp">
                        </div>
                        <div class="form-group">
                            <label for="no_efin">No EFIN</label>
                            <input type="text" class="form-control" id="no_efin" name="no_efin" value="{{ $pajak->no_efin }}" placeholder="No EFIN">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password" name="password" value="{{ $pajak->password }}"
                                placeholder="Password">
                        </div>
                        <div class="form-group">
                            <label for="nik">NIK</label>
                            <input type="text" class="form-control" id="nik" name="nik" value="{{ $pajak->nik }}" placeholder="NIK">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="merk_dagang" name="merk_dagang" value="{{ $pajak->merk_dagang }}"
